...
<template>
    ...
    <div class="overlay">
      ...
      <h3>Users</h3>
                        ...
                        <router-link :to="{ name: 'borrow'}" class="image-container img-four">
                            <div class="overlay">
                              <div class="number-container">{{ counts.books_issued || 'Loading...' }}</div>
                                <h3>Book Issued</h3>
                            </div>
                        </router-link>
                        <router-link :to="{ name: 'editentities'}" class="image-container img-six">
                            <div class="overlay">
                    ...
                    <div class="personal-bests">
                        ...
                        <div class="personal-bests-container">
                          <div class="best-item box-one">
                            <router-link :to="{ name : 'borrowrecords'}" class="number-container">{{ counts.issues_pending }}</router-link>
                                <h3>Pending Approvals </h3>
                
              </div>
              <div class="best-item box-two">
                <div class="number-container">{{ counts.total_reviews }}</div>
                                <h3>Reviews </h3>
          ...
          <div class="friends-activity">
            ...
            <div class="card-container">
              <div class="card">
                ...
                <img class="card-img" src="https://images.pexels.com/photos/2850290/pexels-photo-2850290.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
              </div>
              <div class="card">
                <div class="card-user-info">
                </div>
              ...
              <div class="card card-two">
                ...
                <img class="card-img" src="https://wallpapercave.com/wp/wp9629756.jpg" alt="" />
  ...
  mounted() {
    ...
    fetch('http://localhost:8080/api/chart')
      ...
      .then(data => {
        ...
        Plotly.newPlot('chart', chartData.data, chartData.layout, { displayModeBar: false });
      })
